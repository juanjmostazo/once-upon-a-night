...
<CUSTOMPROPERTIES>
    ...
    <PROPERTY id="PhysicsComponentSimpleBox::length" type="9" value="4 8 4" fields="X;Y;Z;W"></PROPERTY>
	<!-- Logic component properties  -->
	<PROPERTY id="LogicComponent::scriptFilename" type="7" value="scaredplant.lua"></PROPERTY>
	<PROPERTY id="LogicComponent::scriptFunction" type="7" value="scaredplantLogic"></PROPERTY>
  ...
  <PROPERTY id="animation4d::loop" type="12" value="false" ></PROPERTY>
  <PROPERTY id="animation5d::name" type="7" value="shape" ></PROPERTY>
  <PROPERTY id="animation5d::loop" type="12" value="false" ></PROPERTY>
  ...
  <PROPERTY id="animation5n::name" type="7" value="shape" ></PROPERTY>
  <PROPERTY id="animation5n::loop" type="12" value="false" ></PROPERTY>
  <PROPERTY id="animation6n::name" type="7" value="up" ></PROPERTY>
