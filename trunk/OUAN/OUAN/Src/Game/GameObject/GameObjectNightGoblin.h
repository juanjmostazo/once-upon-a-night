#ifndef GameObjectNightGoblinH_H
#define GameObjectNightGoblinH_H
...
namespace OUAN
{
	...
	class GameObjectNightGoblin : public GameObject, public boost::enable_shared_from_this<GameObjectNightGoblin>
	{
	private:
		/// Visual component
	...
	public:
		...
		GameObjectNightGoblin(const std::string& name);
	...
	/// level loader and the "GameObjectNightGoblin"
	class TGameObjectNightGoblinParameters: public TGameObjectParameters
	{
	public:
		/// Default constructor
		TGameObjectNightGoblinParameters();
		/// Default destructor
		~TGameObjectNightGoblinParameters();
