#ifndef GameObjectTowerH_H
#define GameObjectTowerH_H
...
namespace OUAN
{
	...
	class GameObjectTower : public GameObject, public boost::enable_shared_from_this<GameObjectTower>
	{
	private:
	...
	public:
		//Constructor
		GameObjectTower(const std::string& name);
		//Destructor
		~GameObjectTower();
		/// Set logic component
	...
	class TGameObjectTowerParameters: public TGameObjectParameters
	{
	public:
		TGameObjectTowerParameters();
		~TGameObjectTowerParameters();
