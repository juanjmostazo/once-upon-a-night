...
void GameObjectHeart::changeWorldFinished(int world)
{
	if (!isEnabled()) return;
...
void GameObjectHeart::changeWorldStarted(int world)
{
	if (!isEnabled()) return;
...
void GameObjectHeart::changeToWorld(int world, double perc)
{
	if (!isEnabled()) return;
