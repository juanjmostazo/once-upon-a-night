#ifndef GameObjectLevelEntranceH_H
#define GameObjectLevelEntranceH_H
...
namespace OUAN
{
	...
	class GameObjectLevelEntrance : public GameObject, public boost::enable_shared_from_this<GameObjectLevelEntrance>
	{
	private:
	...
	public:
		//Constructor
		GameObjectLevelEntrance(const std::string& name);
		//Destructor
		~GameObjectLevelEntrance();
		/// Set logic component
	...
	{
	public:
		TGameObjectLevelEntranceParameters();
		~TGameObjectLevelEntranceParameters();
