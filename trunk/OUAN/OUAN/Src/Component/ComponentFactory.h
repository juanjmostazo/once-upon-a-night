...
namespace OUAN
{
	...
	public:
		...
		LogicComponentTriggerCameraPtr createLogicComponentTriggerCamera(GameObjectPtr gameObject, TLogicComponentTriggerCameraParameters logicComponentParameters);
