...
namespace OUAN
{
	...
	public:
		...
		LogicComponentActionTriggerPtr createLogicComponentActionTrigger(GameObjectPtr gameObject, TLogicComponentActionTriggerParameters logicComponentParameters);
