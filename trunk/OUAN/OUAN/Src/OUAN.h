...
namespace OUAN
{
	...
	//---------------
		...
		const std::string AVAILABLE_RESOLUTIONS[] = 
		{
			RESOLUTION_800X600X16,
			RESOLUTION_800X600X32,
			RESOLUTION_1024X768X16,
			RESOLUTION_1024X768X32,
			RESOLUTION_1280X1024X16,
			RESOLUTION_1280x1024x32
		};
		const int AVAILABLE_RESOLUTIONS_LEN=6;
