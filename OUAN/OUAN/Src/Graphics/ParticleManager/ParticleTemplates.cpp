...
bool ParticleTemplates::loadConfig()
{
	...
	{
		config.getOption("PORTAL_CHANGE_WORLD_IDLE_DREAMS", PORTAL_CHANGE_WORLD_IDLE_DREAMS); 
		config.getOption("PORTAL_CHANGE_WORLD_IDLE_NIGHTMARES", PORTAL_CHANGE_WORLD_IDLE_NIGHTMARES); 
		...
		config.getOption("TERRAIN_CONVEX_CHANGEWORLD", TERRAIN_CONVEX_CHANGEWORLD); 
