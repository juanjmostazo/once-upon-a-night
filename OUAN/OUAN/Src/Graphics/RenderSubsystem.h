...
namespace OUAN
{
	...
	//Config keys
	const std::string CONFIG_SHADOW_TEXTURE_CASTER_MATERIAL="SHADOW_TEXTURE_CASTER_MATERIAL";
	const std::string CONFIG_SHADOW_TEXTURE_COUNT="SHADOW_TEXTURE_COUNT";
	const std::string CONFIG_SHADOW_TEXTURE_SIZE="SHADOW_TEXTURE_SIZE";
	const std::string CONFIG_SHADOW_TEXTURE_PIXEL_FORMAT="SHADOW_TEXTURE_PIXEL_FORMAT";
	const std::string CONFIG_SHADOW_TEXTURE_CASTER_RENDER_BACK_FACES="SHADOW_RENDER_BACK_FACES";
	const std::string CONFIG_SHADOW_FAR_DISTANCE="SHADOW_FAR_DISTANCE";
