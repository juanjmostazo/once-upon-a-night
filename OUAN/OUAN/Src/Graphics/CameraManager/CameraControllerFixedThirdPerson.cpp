...
void CameraControllerFixedThirdPerson::init(Ogre::SceneManager * pSceneManager)
{
}
...
void CameraControllerFixedThirdPerson::update(Ogre::Camera *pCamera,CameraInputPtr pCameraInput,double elapsedTime)
{

}

void CameraControllerFixedThirdPerson::loadInfo()
{
