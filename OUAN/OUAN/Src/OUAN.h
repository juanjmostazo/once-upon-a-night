...
namespace OUAN
{
	...
	//---------------
		...
		enum QueryFlags
		{
			...
			QUERYFLAGS_FLASHLIGHT_LIGHT = 1<<5,
			QUERYFLAGS_CAMERA_COLLISION=QUERYFLAGS_CAMERA_COLLISION_MOVE_TO_TARGET | QUERYFLAGS_CAMERA_COLLISION_ROTX_POSITIVE | QUERYFLAGS_CAMERA_COLLISION_ROTX_NEGATIVE
			//QUERYFLAGS... = 1<<3
		};
